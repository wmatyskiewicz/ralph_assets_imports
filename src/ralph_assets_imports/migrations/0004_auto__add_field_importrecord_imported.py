...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportRecord.imported'
        db.add_column('ralph_assets_imports_importrecord', 'imported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportRecord.imported'
        db.delete_column('ralph_assets_imports_importrecord', 'imported')
