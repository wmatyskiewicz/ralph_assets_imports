...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportRecord.second_sn'
        db.add_column('ralph_assets_imports_importrecord', 'second_sn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportRecord.second_sn'
        db.delete_column('ralph_assets_imports_importrecord', 'second_sn')
