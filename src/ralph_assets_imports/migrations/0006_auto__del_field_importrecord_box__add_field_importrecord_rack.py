...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImportRecord.box'
        db.delete_column('ralph_assets_imports_importrecord', 'box')

        # Adding field 'ImportRecord.rack'
        db.add_column('ralph_assets_imports_importrecord', 'rack',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ImportRecord.box'
        db.add_column('ralph_assets_imports_importrecord', 'box',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Deleting field 'ImportRecord.rack'
        db.delete_column('ralph_assets_imports_importrecord', 'rack')
