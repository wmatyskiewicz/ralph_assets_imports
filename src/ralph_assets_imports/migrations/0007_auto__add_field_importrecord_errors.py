...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportRecord.errors'
        db.add_column('ralph_assets_imports_importrecord', 'errors',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportRecord.errors'
        db.delete_column('ralph_assets_imports_importrecord', 'errors')
