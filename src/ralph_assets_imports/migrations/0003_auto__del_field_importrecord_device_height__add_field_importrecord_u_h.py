...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImportRecord.device_height'
        db.delete_column('ralph_assets_imports_importrecord', 'device_height')

        # Adding field 'ImportRecord.u_height'
        db.add_column('ralph_assets_imports_importrecord', 'u_height',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ImportRecord.device_height'
        db.add_column('ralph_assets_imports_importrecord', 'device_height',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Deleting field 'ImportRecord.u_height'
        db.delete_column('ralph_assets_imports_importrecord', 'u_height')
