...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ralph_assets_imports_importrecord', (
            ...
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.Device'], null=True)),
            ...
            ('rack', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('u_level', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('u_height', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ...
            ('second_sn', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('errors', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'ralph_assets_imports.importrecord': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.Device']", 'null': 'True'}),
