...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ImportRecord.device' to match new field type.
        db.rename_column('ralph_assets_imports_importrecord', 'device_id', 'device')
        # Changing field 'ImportRecord.device'
        db.alter_column('ralph_assets_imports_importrecord', 'device', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Removing index on 'ImportRecord', fields ['device']
        db.delete_index('ralph_assets_imports_importrecord', ['device_id'])

        # Adding unique constraint on 'ImportRecord', fields ['device']
        db.create_unique('ralph_assets_imports_importrecord', ['device'])


    def backwards(self, orm):
        # Removing unique constraint on 'ImportRecord', fields ['device']
        db.delete_unique('ralph_assets_imports_importrecord', ['device'])

        # Adding index on 'ImportRecord', fields ['device']
        db.create_index('ralph_assets_imports_importrecord', ['device_id'])


        # Renaming column for 'ImportRecord.device' to match new field type.
        db.rename_column('ralph_assets_imports_importrecord', 'device', 'device_id')
        # Changing field 'ImportRecord.device'
        db.alter_column('ralph_assets_imports_importrecord', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.Device'], null=True))
    ...
    models = {
        ...
        'ralph_assets_imports.importrecord': {
            ...
            'device': ('django.db.models.fields.IntegerField', [], {'default': "u''", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
